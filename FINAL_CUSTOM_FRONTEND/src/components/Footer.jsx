        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/functions" className="text-gray-400 hover:text-white transition-colors">
                  Functions
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>📞 <a href="tel:+91 9989324091" className="hover:text-white">+91 98765 43210</a></li>
