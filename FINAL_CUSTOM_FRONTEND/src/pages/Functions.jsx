...
const Functions = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess('Thank you! Your functions inquiry has been submitted. We will contact you shortly with details.');
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold mb-4 text-gray-800">Functions Services</h1>
          <p className="text-xl text-gray-600">
            Make your events memorable with our delicious functions
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600">
              Perfect functions for birthdays, anniversaries, and celebrations
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            <div className="text-6xl mb-4">💼</div>
            ...
            <p className="text-gray-600">
              Professional functions for meetings, conferences, and office parties
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            <div className="text-6xl mb-4">👰</div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          <h2 className="text-3xl font-bold mb-6 text-gray-800 text-center">Why Choose Our Functions?</h2>
